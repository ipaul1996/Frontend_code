...
//try block got executed if promise state of p1 object is 'fulfilled'. Here 'await p1' 
//returns the promiseresult and store in res. The await operator is used to wait for a 
//Promise
//catch block got executed if promise state of p1 object is 'rejected'. Here err accepts 
//the promiseresult
