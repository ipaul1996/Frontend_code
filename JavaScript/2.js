...
console.log(typeof(myVar)); //"undefined" --> Here the type of myVar is undefined returned as a String
...
//When we add 1 to Number.MAX_VALUE, the resulting value is very close to the largest number 
//that can be represented within the fixed precision of the floating-point number representation.
